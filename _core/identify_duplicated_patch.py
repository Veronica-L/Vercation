...
from _core.extract_tag import GitLog

#from setting import *

from git_analysis.analyze_git_logs import retrieve_git_logs, retrieve_git_logs_dict, get_ancestors, get_parent_tags, \
    get_son_tags

#repos_dir = REPOS_DIR
#log_dir = LOG_DIR
log_dir = '/home/cyr/mywork/VulLocate/meta'
...
if __name__ == '__main__':
    ...
    batch_duplicate_detection(['FFmpeg'])
